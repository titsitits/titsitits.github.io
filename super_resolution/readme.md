...
<h3 class="title">Un notebook self-contained pour tester différents algorithmes de Deep Learning</h3>
...
Dans ce contexte (i.e. la super-résolution d’image), le but est de prédire une image de meilleure qualité (plus réaliste, et ayant plus de pixels) à partir d’une image d’entrée plus petite (voir Figure 2) :
...
Certains travaux s’appuient sur un nouveau type d’architecture de DNN, particulièrement ingénieuse: les réseaux antagonistes génératifs (Generative Adversarial Networks - GAN, voir Figure 3)<sup>[[6]](#ftnt6)</sup>. Un GAN consiste en la mise en compétition de deux modèles distincts: un modèle “génératif” et un modèle “discriminatif”. Le premier est entraîné à reconstruire une image de grande résolution la plus réaliste possible à partir de l’image de faible résolution. Le second est par contre entraîné à partir des images produites par le premier, à déterminer si cette image est réelle ou non. Un mécanisme de feedback permet alors au premier modèle de s’adapter pour tenter de convaincre le mieux possible le deuxième modèle que les images qu’il synthétise sont réelles. Plus précisément, le premier modèle est littéralement optimisé pour maximiser l’erreur du deuxième, en générant des images les plus réalistes possibles. On peut dire en quelque sorte que le premier modèle est entraîné à berner le deuxième, qui lui est entraîné à être de plus en plus perspicace (à ne pas se faire berner).

Quelque soit le modèle, l’amélioration d’une image reste cependant une notion en partie subjective puisqu’elle dépend de la perception d’un individu. En outre, la dégradation d’une image lors de son acquisition dépend également du capteur utilisé, et selon le type de dégradation du capteur, différents modèles peuvent s’avérer plus adaptés que d’autres [[1]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/dG6f&sa=D&ust=1566390330230000). Pour tenter de répondre à cette subjectivité, une mesure basée sur l’opinion moyenne de différentes personnes (“Mean Opinion Score” - MOS) est parfois utilisée. En l’occurrence, les méthodes basées sur les GANs ont des résultats particulièrement bons selon cette mesure [[2]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/iO8r&sa=D&ust=1566390330230000).

Ainsi, de nombreux travaux se réclament supérieurs aux autres, sous couvert d’un benchmark bien précis et selon une mesure bien précise à laquelle leur modèle est plus adapté. Par exemple, Yu et al. (2018) [[3]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/QmCt&sa=D&ust=1566390330230000) indiquent sur leur répertoire github<sup>[[7]](#ftnt7)</sup>qu’ils ont gagné la compétition NTIRE 2018 [[4]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/a4re&sa=D&ust=1566390330231000). Mais d’autre part, Haris et al. (2018) [[5]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/Uq6k&sa=D&ust=1566390330231000) indiquent sur leur propre répertoire github<sup>[[8]](#ftnt8)</sup>avoir remporté la même compétition, ainsi qu’une autre, la PIRM 2018 [[6]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/7Jfw&sa=D&ust=1566390330231000)... Cette dernière aurait cependant été également remportée par Wang et al. (2019) [[7]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/66jd&sa=D&ust=1566390330232000) comme ils le revendiquent également sur leur répertoire github.<sup>[[9]](#ftnt9)</sup> Bien sûr, chaque équipe a en réalité remporté une discipline spécifique, de la même manière que Kevin Borlée peut remporter la course au 400m mais être dernier au 100m haie aux mêmes Jeux Olympiques.
...
1.  Enhanced Deep Residual Networks for Single Image Super-Resolution (EDSR) [[8]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/c6Tx&sa=D&ust=1566390330235000)
2.  Wide Activation for Efficient and Accurate Image Super-Resolution (WDSR) [[3]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/QmCt&sa=D&ust=1566390330235000)
3.  Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network (SRGAN) [[2]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/iO8r&sa=D&ust=1566390330236000)
4.  Enhanced super-resolution generative adversarial networks (ESRGAN) [[7]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/66jd&sa=D&ust=1566390330236000)
5.  Deep Back-Projection Networks For Super-Resolution (DBPN) [[5]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/Uq6k&sa=D&ust=1566390330237000)
6.  Feedback Network for Image Super-Resolution (SRFBN) [[9]](https://www.google.com/url?q=https://paperpile.com/c/OM3Y77/jgr9&sa=D&ust=1566390330237000)
...
A l’inverse, de nombreux exemples moins concluants ont été obtenus avec chaque algorithmes, comme on peut le voir à la Figure 6\. L’ensemble des résultats peut être vu (ou regénéré) à partir du [notebook colab](https://www.google.com/url?q=https://colab.research.google.com/github/titsitits/Test_images_superresolution/blob/master/Super_resolution_comparison.ipynb&sa=D&ust=1566390330242000) fourni avec cet article.
...
1.     Chen C, Xiong Z, Tian X, Zha Z-J, Wu F. Camera Lens Super-Resolution [Internet]. 2019. Available: http://arxiv.org/abs/1904.03378
2.     Ledig C, Theis L, Huszar F, Caballero J, Cunningham A, Acosta A, et al. Photo-Realistic Single Image Super-Resolution Using a Generative Adversarial Network [Internet]. 2016. Available: http://arxiv.org/abs/1609.04802
3.     Yu J, Fan Y, Yang J, Xu N, Wang Z, Wang X, et al. Wide Activation for Efficient and Accurate Image Super-Resolution [Internet]. 2018. Available: http://arxiv.org/abs/1808.08718
4.     Timofte R, Gu S, Van Gool L, Zhang L, Yang M-H. NTIRE 2018 Challenge on Single Image Super-Resolution: Methods and Results [Internet]. 2018 IEEE/CVF Conference on Computer Vision and Pattern Recognition Workshops (CVPRW). 2018. doi:10.1109/cvprw.2018.00130
5.     Haris M, Shakhnarovich G, Ukita N. Deep Back-Projection Networks For Super-Resolution [Internet]. 2018. Available: http://arxiv.org/abs/1803.02735
6.     Blau Y, Mechrez R, Timofte R, Michaeli T, Zelnik-Manor L. The 2018 PIRM Challenge on Perceptual Image Super-resolution [Internet]. 2018. Available: http://arxiv.org/abs/1809.07517
7.     Wang X, Yu K, Wu S, Gu J, Liu Y, Dong C, et al. ESRGAN: Enhanced Super-Resolution Generative Adversarial Networks [Internet]. Lecture Notes in Computer Science. 2019. pp. 63–79. doi:10.1007/978-3-030-11021-5_5
8.     Lim B, Son S, Kim H, Nah S, Lee KM. Enhanced Deep Residual Networks for Single Image Super-Resolution [Internet]. 2017. Available: http://arxiv.org/abs/1707.02921
9.     Li Z, Yang J, Liu Z, Yang X, Jeon G, Wu W. Feedback Network for Image Super-Resolution [Internet]. 2019. Available: http://arxiv.org/abs/1903.09814